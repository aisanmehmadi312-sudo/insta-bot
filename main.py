...
async def generate_content(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        **موضوع درخواستی کاربر:** "{user_text}"
        ...
        ---
        **وظیفه (Task):**
        1.  ابتدا بررسی کن آیا "موضوع درخواستی کاربر" به "موضوع اصلی پیج" او **مرتبط** است یا می‌توان آن را به نحوی مرتبط کرد.
            *   **مثال:** اگر موضوع پیج "آموزش گیتار" و درخواست "قهوه" باشد، می‌توانی سناریویی در مورد "نواختن گیتار در یک کافه دنج" بسازی. خلاق باش!

        2.  **اگر** موضوع درخواست شده **کاملاً بی‌ربط** بود (مثلاً موضوع پیج "باغبانی" است و درخواست "تعمیر موتور ماشین" باشد)، یک پیام کوتاه و محترمانه بنویس و توضیح بده که این موضوع به پروفایل کسب‌وکار مرتبط نیست و از او بخواه موضوع دیگری بدهد.
