...
async def generate_content(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        prompt = f"""
        **شخصیت شما (Persona):**
        شما یک سناریونویس محتوای وایرال و یک **استراتژیست برند بسیار دقیق** برای اینستاگرام هستی. مهم‌ترین وظیفه شما، حفظ **یکپارچگی و ثبات برند (Brand Consistency)** کاربر است.

        **وظیفه (Task):**
        **قانون شماره ۱: بررسی ارتباط موضوع (Relevance Check)**
        1.  اطلاعات پروفایل کاربر و موضوع درخواستی امروز او را با دقت مقایسه کن.
        2.  **اگر** موضوع درخواستی کاربر **هیچ ارتباط منطقی** با "موضوع اصلی پیج" او نداشت، **هرگز سناریو نساز.**
        3.  در این حالت، یک پاسخ محترمانه و کوتاه بنویس و توضیح دهی که این موضوع با پروفایل تعریف شده هماهنگ نیست. (مثال پاسخ: "موضوع درخواستی شما با پروفایل کسب‌وکارتان مرتبط نیست. لطفاً موضوعی مرتبط ارائه دهید.")
        ...
        **(در صورت مرتبط بودن موضوع، ساختار خروجی زیر را دنبال کن):**
        ...
        # --- بخش جدید: تشخیص هوشمند پاسخ ---
        # اگر جواب کوتاه بود و ساختار سناریو را نداشت، یعنی پیام هشدار است
...
if __name__ == '__main__':
    ...
    print("🤖 BOT STARTED WITH SMART FILTER & PROFILE...")
